# Operator Quickstart — Prepared Animal Feeds Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1080** (`cloud-itonami-isic-1080`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1080.git
cd cloud-itonami-isic-1080
```
...
- Blueprint governor key: `feedops-governor`
- Likely source path: `feedops.governor.cljc`
